				...
				<div class="pd-20 card-box mb-30">
					...
					<form name="myform" method="post">
						<div class="form-group">
							<label>문의 제목</label>
							<input class="form-control" id="title" name="title" placeholder="문의 제목을 입력하세요" type="text">
						</div>
						<div class="form-group">
							<label>문의 유형</label>
						...
						<input type="button" value="문의글 작성" onclick="fCheck()" style="float: right;" class="btn btn-success ml-2" />
