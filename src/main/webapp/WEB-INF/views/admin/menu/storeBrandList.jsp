...
<div id="main" style="margin-left : 0; padding-left: 0px;">
	...
	<div class="w3-container" style="width:40%;">
	  <h2>가게 프랜차이즈 목록</h2><br />
	  <button type="button" onclick="location.href='${ctp}/admin/adminStoreBrandInput';" class="w3-right w3-button w3-round-large w3-blue w3-margin-bottom">새 브랜드 등록</button>
