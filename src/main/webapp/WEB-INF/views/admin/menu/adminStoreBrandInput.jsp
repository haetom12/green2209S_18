...
<div class="w3-container">
  <form name="myform" method="post" >
	  <h2 class="text-center">프랜차이즈 등록</h2>
	  <br/>
	  ...
	  프랜차이즈 명 :
	  <div class="loginbox-textbox input-group" style="margin: 0 auto;">
       <input type="text" name="brandName" id="brandName"  placeholder="프렌차이즈를 입력하세요" class="form-control" style="width: 200px;" required />
    ...
    <div style="font-size: 10px; margin-bottom: 5px;" id="demo2"></div>
	  <div class="mb-2">
	    <input type="button" value="프렌차이즈 등록" onclick="fCheck()" class="btn btn-primary"/> &nbsp;
