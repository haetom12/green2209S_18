...
<div id="main" style="margin-left : 0; padding-left: 0px;">
	...
	<div class="w3-container" style="width:35%;">
	  <h2>${brandName}의 태그 목록</h2><br />
	  <button type="button" onclick="location.href='${ctp}/admin/adminStoreTagInput?brandName=${brandName}';" class="w3-right w3-button w3-round-large w3-blue w3-margin-bottom">새 태그 등록</button>
	  <table class="w3-table-all memtable w3-centered">
	    ...
	    <c:forEach var="vo" items="${vos}" varStatus="st">
	   		<tr>
		    	...
		    	<td>
		    	 <input type="button" onclick="location.href='${ctp}/admin/adminStoreTagUpdate?brandName=${vo.brandName}&foodTag=${vo.foodTag}';" class="w3-button w3-round-large w3-orange" value="태그 수정" />
		    	 <input type="button" onclick="deleteTag('${vo.foodTag}','${vo.brandName}')" class="w3-button w3-round-large w3-red" value="태그 삭제" />
		    	</td>
		    </tr>
