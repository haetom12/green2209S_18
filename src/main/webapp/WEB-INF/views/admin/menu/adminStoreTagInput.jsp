...
<div class="w3-overlay w3-hide-large w3-animate-opacity" onclick="w3_close()" style="cursor:pointer" title="close side menu" id="myOverlay"></div>
	...
	<div class="w3-container">
	  <form name="myform" method="post">
		  ...
		  음식 태그 :
		  <div class="loginbox-textbox input-group" style="margin: 0 auto;">
	       <input type="text" name="foodTag" id="foodTag"  placeholder="음식 태그를 입력하세요" class="form-control" style="width: 200px;" required />
	    ...
	    <div style="font-size: 10px;" id="demo2" class="mb-3"></div>
		  <div class="mb-2">
		    ...
		    <input type="button" value="돌아가기" onclick="location.href='${ctp}/admin/storeTagList?brandName=${vo.brandName}';" class="btn btn-secondary"/> &nbsp;    
		  </div>
	  </form>
	</div>
	<br />
