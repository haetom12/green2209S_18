	...
	<div class="main-container">
		<div class="container">
				<div class="pd-20 card-box mb-50">
					<div class="clearfix">
						<h3 class="text-blue h3" style="text-align: center;">음식 태그 수정</h3>
					</div>
					<form name="myform" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label>브랜드 명</label>
							<input class="form-control mb-2" name="brandName" id="brandName" value="${brandName}"  style="width: 40%;" type="text" readonly>
						</div>
						<div class="form-group">
							<label>태그 명</label>
							<input class="form-control mb-2" name="foodTag" id="foodTag" value="${foodTag}"  style="width: 40%;" type="text">
						...
						<div class="form-group">
							<div class="row">
								<input type="button" value="돌아가기" onclick="location.href='${ctp}/admin/storeTagList?brandName=${brandName}';"  class="btn btn-secondary ml-3 mr-2" />
								<input type="reset" value="다시쓰기" class="btn btn-warning"/>
								<input type="button" value="태그 수정" onclick="fCheck()"  class="btn btn-success ml-2" />
