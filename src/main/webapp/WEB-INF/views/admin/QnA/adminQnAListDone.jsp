		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				<div class="card-box mb-30">
					<div class="pd-20">
						<h3 class="h3 text-center">답변완료 문의</h3>
					</div>
					<div class="pb-20">
						...
						<form name="myform">
					  	<div class="row mb-2">
					  	  ...
					  	  <div class="col text-right"><button type="button" onclick="location.href='${ctp}/admin/QnAListYet';" class="btn btn-success mr-2">전체검색</button></div>
					  	</div>
					  </form>
