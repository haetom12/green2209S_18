  ...
  <form name="myform" method="post" enctype="multipart/form-data">
	  ...
	  분류 코드 :
	  	<div class="loginbox-textbox input-group" style="margin: 0 auto;">
		    <input type="text" name="categoryStoreCode" id="categoryStoreCode" value="${vo.categoryStoreCode}" class="form-control" style="width: 100px;" required />
		    <input type="button" class="btn btn-primary" id="midBtn" onclick="CodeCheck()" style="width: 15%; text-align: center;"  value="중복체크">
	  	</div>
	  </div>
	  <div style="font-size: 10px;" id="demo"></div>
	  카테고리 :
	  <div class="loginbox-textbox input-group" style="margin: 0 auto;">
       <input type="text" name="storePart" id="storePart" value="${vo.storePart}" class="form-control" style="width: 200px;" required />
    ...
    <div style="font-size: 10px;" id="demo2"></div>
	  ...
	  <div class="mb-2">
	    <input type="button" value="카테고리 수정" onclick="fCheck()" class="btn btn-primary"/> &nbsp;
