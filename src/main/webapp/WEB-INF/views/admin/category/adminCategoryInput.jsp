				...
				<div class="pd-20 card-box mb-50">
					...
					<form name="myform" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label>분류 코드</label>
							<input class="form-control mb-2" name="categoryStoreCode" id="categoryStoreCode" placeholder="분류코드를 입력하세요" style="width: 40%;" type="text" >
						...
						<div class="form-group">
							<label>카테고리</label>
							<input class="form-control mb-2" name="storePart" id="storePart" placeholder="카테고리명을 입력하세요" style="width: 40%;" type="text">
