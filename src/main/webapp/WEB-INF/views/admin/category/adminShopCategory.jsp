...
<div id="main" style="margin-left : 0; padding-left: 0px;">
	...
	<div class="w3-container" style="width:40%;">
	  <h2>카테고리 목록</h2><br />
	  <button type="button" onclick="location.href='${ctp}/admin/adminCategoryInput';" class="w3-right w3-button w3-round-large w3-blue w3-margin-bottom">새 카테고리 등록</button>
	  <table class="w3-table-all memtable w3-centered">
	    ...
	    <c:forEach var="vo" items="${vos}" varStatus="st">
	   		<tr>
		    	<td>${st.count}</td>
		    	<td>${vo.storePart}</td>
		    	<td><img src="${ctp}/data/categoryPhoto/${vo.categoryPhoto}" style="width:100px; cursor:zoom-in"
	  							onclick="document.getElementById('${st.count}').style.display='block'"></td>
		    	<td>
		    	 <input type="button" onclick="location.href='${ctp}/admin/adminUpdateCategory?storePart=${vo.storePart}';" class="w3-button w3-round-large w3-green" value="수정" />
		    	 <input type="button" onclick="DelCheck('${vo.storePart}')" class="w3-button w3-round-large w3-red" value="삭제" />
		    	</td>
		    </tr>
