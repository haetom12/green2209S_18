		  ...
		  let emailCheckSw = 0;
			...
			function JoinCheck() {
		      ...
		      let tel3 = JoinForm.tel3.value;
		        ...
		        alert("음식점 이름은 한글과 영문대소문자만 사용가능합니다.");
		...
		<section class="py-5 overflow-hidden" style="background-color: #f4a259">
	        ...
	        <div class="loginbox bg-white">
	            ...
	            <div class="loginbox-textbox">
	                <input type="text" class="form-control" id="storeName" name="storeName" placeholder="음식점 이름을 입력하세요"  style="width: 85%; margin: 0 auto;" required>
	            </div>
