			...
			<div class="container" >
				<section class="py-5 overflow-hidden" >
			        ...
			        <div class="loginbox bg-light">
			            <div class="fw-bold text-danger fs-3 fs-lg-5 lh-sm my-2 mt-2 text-center"><font size="20pt">추가메뉴 등록</font></div>
			            <div class="loginbox-or">
			                <div class="or-line"></div>
			            </div>
			            <div class="loginbox-textbox fw-bold text-danger fs-3 fs-lg-1 lh-sm" style="margin-left: 7%;">음식 태그</div>
			            <div class="loginbox-textbox">
			                <input type="text" class="form-control" id="foodTag" name="foodTag" value="${foodTag}" style="width: 85%; margin: 0 auto;" readonly required>
			            </div>
			            ...
			            <div class="loginbox-textbox input-group" style="width: 85.5%; margin: 0 auto;">
			                <input type="text" class="form-control" id="subMenuName" name="subMenuName" placeholder="메뉴명 입력하세요" style="width: 100px;" required>&nbsp;
		                ...
		                <input type="button" onclick="location.href='${ctp}/store/myStoreSubMenu?foodTag=${foodTag}';" class="btn btn-primary" value="돌아가기" style="width: 22%;  margin-left: 15%;">
			            </div>
